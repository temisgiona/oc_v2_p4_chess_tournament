...
<html>
   <head>
      <title>flake8 violations: .\env\Lib\site-packages\adodbapi\examples\db_table_names.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="env.Lib.site-packages.adodbapi.examples.db_table_names.source.html">
               <img src="file.svg" alt="&#x2261;">
            </a></p>
         <h1>
            <a href="index.html">
               <img src="back.svg" alt="&#x2B05;">
               .\env\Lib\site-packages\adodbapi\examples\db_table_names.py
            </a>
         </h1>
         ...
         <li>
            ...
            <li>
               ...
               <a href="env.Lib.site-packages.adodbapi.examples.db_table_names.source.html#l13">
                  <tt><i>13</i> <span class="c1">#create the connection</span></tt>
               </a>
            </li>
            </ul>
         </li>
