...
<html>
   <head>
      <title>flake8 violations: .\env\Lib\site-packages\flask_jwt_extended\exceptions.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="env.Lib.site-packages.flask_jwt_extended.exceptions.source.html">
               <img src="file.svg" alt="&#x2261;">
            </a></p>
         <h1>
            <a href="index.html">
               <img src="back.svg" alt="&#x2B05;">
               .\env\Lib\site-packages\flask_jwt_extended\exceptions.py
            </a>
         </h1>
         ...
         <li>
            ...
            <li>
               ...
               <a href="env.Lib.site-packages.flask_jwt_extended.exceptions.source.html#l35">
                  <tt><i>35</i> <span class="sd">    An error raised when no authorization token was found in a protected endpoint</span></tt>
               </a>
            </li>
            </ul>
         </li>
