      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="env.Lib.site-packages.numpy.lib.stride_tricks.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="env.Lib.site-packages.numpy.lib.stride_tricks.source.html#l72">
                  <tt><i>72</i> <span class="sd">        userfriendly and safe function for the creation of sliding window views.</span></tt>
               </a>
            </li>
            </ul>
         </li>
         ...
         <li>
            ...
            <li>
               ...
               <a href="env.Lib.site-packages.numpy.lib.stride_tricks.source.html#l131">
