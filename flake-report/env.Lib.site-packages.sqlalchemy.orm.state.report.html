...
<html>
   <head>
      <title>flake8 violations: .\env\Lib\site-packages\sqlalchemy\orm\state.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="env.Lib.site-packages.sqlalchemy.orm.state.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="env.Lib.site-packages.sqlalchemy.orm.state.source.html#l431">
                  <tt><i>431</i>         <span class="k">except</span><span class="p">:</span></tt>
               </a>
            </li>
            </ul>
         </li>
