      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="env.Lib.site-packages.numpy.lib.index_tricks.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="env.Lib.site-packages.numpy.lib.index_tricks.source.html#l625">
                  <tt><i>625</i> <span class="sd">        The size of each dimension of the array can be passed as </span></tt>
               </a>
            </li>
            </ul>
         </li>
