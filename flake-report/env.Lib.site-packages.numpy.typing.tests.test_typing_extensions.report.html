...
<html>
   <head>
      <title>flake8 violations: .\env\Lib\site-packages\numpy\typing\tests\test_typing_extensions.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="env.Lib.site-packages.numpy.typing.tests.test_typing_extensions.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="env.Lib.site-packages.numpy.typing.tests.test_typing_extensions.source.html#l35">
                  <tt><i>35</i> &nbsp;</tt>
               </a>
            </li>
            </ul>
