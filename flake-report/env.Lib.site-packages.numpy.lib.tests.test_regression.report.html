      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="env.Lib.site-packages.numpy.lib.tests.test_regression.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="env.Lib.site-packages.numpy.lib.tests.test_regression.source.html#l1">
                  <tt><i>1</i> <span class="kn">import</span> <span class="nn">pytest</span></tt>
               </a>
            </li>
            </ul>
         </li>
