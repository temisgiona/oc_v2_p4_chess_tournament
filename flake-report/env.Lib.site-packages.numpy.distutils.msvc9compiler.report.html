      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="env.Lib.site-packages.numpy.distutils.msvc9compiler.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="env.Lib.site-packages.numpy.distutils.msvc9compiler.source.html#l13">
                  <tt><i>13</i> <span class="sd">    or the same as the old string if obtained from the same environment. The aim</span></tt>
               </a>
            </li>
            </ul>
         </li>
