      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="env.Lib.site-packages.numpy.typing.tests.data.pass.simple.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="env.Lib.site-packages.numpy.typing.tests.data.pass.simple.source.html#l59">
                  <tt><i>59</i> <span class="k">def</span> <span class="nf">iterable_func</span><span class="p">(</span><span class="n">x</span><span class="p">):</span></tt>
               </a>
            </li>
            </ul>
         </li>
